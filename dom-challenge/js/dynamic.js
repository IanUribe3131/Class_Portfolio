...
const updateCounter = () => {
    ...
    const totalCards = actionList.children.length;
    cardCounter.textContent = totalCards;
};
...
actionForm.addEventListener('submit', (e) => {
    ...
    const text = actionInput.value.trim(); //trim trims all the spaces before and after the actual text in the actionInput value
